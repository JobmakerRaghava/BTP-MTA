sap.ui.define([
    ...
    Controller,
    JSONModel, Engine, Filter, FilterOperator, QuickSort, QuickSortItem
) {
    "use strict";
    return Controller.extend("taqamainttables.controller.BaseController", {
        ...
        //     // Iterating through each column in the table to set a header menu with sorting options
        //     aColumns.forEach(function (oColumn) {
        //         // Create QuickSort items for each column dynamically
        //         const sColumnName = oColumn.getLabel().getText(); // Assuming the column label text is used as the key for sorting
        //         const oQuickSortItem = new QuickSortItem({
        //             key: sColumnName,
        //             label: sColumnName
        //         });

        //         // Create QuickSort functionality for each column
        //         const oQuickSort = new QuickSort({
        //             items: oQuickSortItem,
        //             change: function (oEvent) {
        //                 const oBinding = oTable.getBinding("items");
        //                 const sSortOrder = oEvent.getParameter("item").getSortOrder();
        //                 const sSortProperty = oEvent.getParameter("item").getKey(); // The key is the column name

        //                 // Apply the sort order for the selected column
        //                 const oSorter = new Sorter(sSortProperty, sSortOrder === "Descending");
        //                 oBinding.sort(oSorter);

        //                 // Set the sort indicator for the clicked column and reset others
        //                 aColumns.forEach(function (col) {
        //                     col.setSortIndicator("None"); // Reset all columns' sort indicators
        //                 });
        //                 oColumn.setSortIndicator(sSortOrder === "Ascending" ? "Ascending" : "Descending");
        //             }
        //         });

        //         // Set the header menu for each column
        //         oColumn.setHeaderMenu(new ColumnMenu({
        //             quickActions: [oQuickSort]
        //         }));
        //     });
        // },
