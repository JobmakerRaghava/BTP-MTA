		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#taqatesttest2dms-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"taqatesttest2dms-display": {
								"semanticObject": "taqatesttest2dms",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=taqa.test.test2dms",
									"url": sap.ui.require.toUrl("taqa/test/test2dms")
								}
							}
						}
					}
