		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Travel Request Application(LPO)",
									"targetURL": "#taqafocaltravelrequestapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"taqafocaltravelrequestapp-display": {
								"semanticObject": "taqafocaltravelrequestapp",
								"action": "display",
								"description": "Travel Request Application(LPO)",
								"title": "Travel Request Application(LPO)",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=taqafocaltravelrequestapp",
									"url": sap.ui.require.toUrl("taqafocaltravelrequestapp")
								}
							}
						}
					}
