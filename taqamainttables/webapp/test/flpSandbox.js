		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#taqamainttables-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"taqamainttables-display": {
								"semanticObject": "taqamainttables",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=taqamainttables",
									"url": sap.ui.require.toUrl("taqamainttables")
								}
							}
						}
					}
