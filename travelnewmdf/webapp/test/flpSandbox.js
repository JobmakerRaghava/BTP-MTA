		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#taqatravelnewmdf-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"taqatravelnewmdf-display": {
								"semanticObject": "taqatravelnewmdf",
								"action": "display",
								"description": "Travel",
								"title": "Travel Management",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=taqa.travelnewmdf",
									"url": sap.ui.require.toUrl("taqa/travelnewmdf")
								}
							}
						}
					}
