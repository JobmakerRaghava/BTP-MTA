		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Admin Travel Request",
									"targetURL": "#taqaadmintravelreq-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"taqaadmintravelreq-display": {
								"semanticObject": "taqaadmintravelreq",
								"action": "display",
								"description": "Admin Travel Request",
								"title": "Admin Travel Request",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=taqaadmintravelreq",
									"url": sap.ui.require.toUrl("taqaadmintravelreq")
								}
							}
						}
					}
