		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comtaqatravelreportsztravelreports-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtaqatravelreportsztravelreports-display": {
								"semanticObject": "comtaqatravelreportsztravelreports",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.taqa.travelreports.ztravelreports",
									"url": sap.ui.require.toUrl("com/taqa/travelreports/ztravelreports")
								}
							}
						}
					}
