		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#taqaemployeetravelrequestapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"taqaemployeetravelrequestapp-display": {
								"semanticObject": "taqaemployeetravelrequestapp",
								"action": "display",
								"description": "Employee Travel Request application.",
								"title": "Employee Travel Request",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=taqaemployeetravelrequestapp",
									"url": sap.ui.require.toUrl("taqaemployeetravelrequestapp")
								}
							}
						}
					}
