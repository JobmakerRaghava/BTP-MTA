		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#taqatravelagencyapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"taqatravelagencyapp-display": {
								"semanticObject": "taqatravelagencyapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=taqatravelagencyapp",
									"url": sap.ui.require.toUrl("taqatravelagencyapp")
								}
							}
						}
					}
